...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      saveAuth(data);
      showMsg(messageEl, `Welcome, ${data.user.username}!`, false);
      ...
      console.error(err);
      if (err.status === 403) {
        showMsg(messageEl, "This account is not a buyer account. Use the correct login page.", true);
